...
define config.name = _("GiocoRenpy")
...
define build.name = "GiocoRenpy"


## Suoni e musica ##############################################################

## Queste tre variabili controllano quali mixer audio sono mostrati al
## giocatore. Impostare una di esse su 'False' nasconderà il mixer audio
## relativo.
...
define config.save_directory = "GiocoRenpy-1618334232"
